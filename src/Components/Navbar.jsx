    ...
    return (
        <Container>
            <header className="header" style={{ backgroundColor: `${colorChange ? 'white' : 'transparent'}` }}>
                <a href="/" className="logo">Mahipal</a>
                ...
                <ul className="menu">
                    ...
                    <li><div className='resumeBox'><a className='resume' target="_blank" href="https://drive.google.com/file/d/1jT4SevOWy_LwUn3u9Zk6DSKDTlC50LUz/view?usp=drive_link">
                        Resume<DownloadIcon />
                    </a></div></li>
                </ul>
            </header>
