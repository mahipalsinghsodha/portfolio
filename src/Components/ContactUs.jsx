...
const ContactUs = () => {
    ...
    const handleSubmission = (e) => {
        ...
        if (data.name && data.email && data.subject && data.message) {
            emailjs.send('service_7e4d0b5', 'template_i395sse', data, '6B9xTmgLEULxRK3zo')
                .then((response) => {
                    setSubmit(true)
                }).catch((error) => {
                    setSubmit(false)
    ...
    return (
        <Container id='contact'>
                ...
                <div className='contactText'>
                    ...
                    <div className='middleSection'>
                        <div>
                            ...
                            <a href="https://www.linkedin.com/in/mahipal-singh-03a3391ab/" rel="noreferrer" target="_blank">
                                <p>Mahipal Singh</p>
                            </a>
                        </div>
                        <div>
                            ...
                            <a href="tel:+917665306403" rel="noreferrer" target="_blank">
                                <p>+917665306403</p>
                            </a>
                        </div>
                        <div>
                            ...
                            <a href='mailto:mssodha2510@gmail.com' rel="noreferrer" target="_blank"><p>mssodha2510@gmail.com</p></a>
                        </div>
                        <div>
                            <LocationOnIcon fontSize="large" />
                            <h1>Location</h1>
                            <p>Jaisalmer,Rajasthan</p>
                            <a  href="https://www.google.com/maps/place/Khuri,+Dhoba,+Khoohdi,+Rajasthan+345034/@26.6135972,70.7148828,17z/data=!3m1!4b1!4m6!3m5!1s0x3947cc828f591269:0x3949d7d8ed6fa4d2!8m2!3d26.6132994!4d70.7149884!16s%2Fg%2F1tcy2pnh?entry=ttu" rel="noreferrer" target="_blank">
            ...
            <div className='endSection'>
                <p>© 2023 Mahipal. Design by Me with <FavoriteIcon sx={{ color: '#01a479' }} /></p>
            </div>
        </Container>
    )
}
